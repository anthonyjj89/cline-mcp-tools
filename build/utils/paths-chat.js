 ...
 */
export function getVSCodeChatsDirectory() {
 ...
 */
export function getChatDirectory(chatsDir, chatId) {
 ...
 */
export function getApiConversationFilePath(chatsDir, chatId) {
 ...
 */
export function getUiMessagesFilePath(chatsDir, chatId) {
 ...
 */
export async function chatExists(chatsDir, chatId) {
    try {
 ...
 */
export async function apiConversationFileExists(chatsDir, chatId) {
    try {
 ...
 */
export async function uiMessagesFileExists(chatsDir, chatId) {
    try {
