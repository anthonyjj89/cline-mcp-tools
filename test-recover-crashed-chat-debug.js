/**
 * Debug script for the recover_crashed_chat MCP tool
 * This script provides detailed logging to diagnose issues with the MCP tool interface
 */
...
async function testRecoverCrashedChat() {
  try {
    ...
    console.log('Tool description:', recoverTool.description);
    console.log('Tool input schema:', JSON.stringify(recoverTool.inputSchema, null, 2));
