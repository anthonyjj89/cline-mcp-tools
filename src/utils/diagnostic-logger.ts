 ...
 */
export function initDiagnosticLogger(logLevel: LogLevel = LogLevel.INFO): void {
  try {
    // Clear previous log
    ...
    console.error(`Failed to initialize diagnostic logger: ${(error as Error).message}`);
  }
}
...
export function disableConsoleLogging(): void {
  ...
  try {
    ...
    console.error(`Failed to write disableConsoleLogging message to log file: ${(e as Error).message}`);
  }
}
 ...
 */
export function diagnosticLog(message: string, data: any = null, level: LogLevel = LogLevel.DEBUG): void {
  ...
  if (data !== null) {
    try {
      ...
      logMessage += `: [Error stringifying data: ${(e as Error).message}]`;
    }
  }
  ...
  try {
    ...
    console.error(`\x1b[31mFailed to write to diagnostic log: ${(e as Error).message}\x1b[0m`);
  }
}
 ...
 */
export function logError(message: string, error: any = null): void {
 ...
 */
export function logWarning(message: string, data: any = null): void {
 ...
 * @param data Optional data
 */
export function logInfo(message: string, data: any = null): void {
